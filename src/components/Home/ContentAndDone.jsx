        ...
        <div className="h-fit overflow-hidden grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 items-start mx-auto md:mt-0">
          <article className="w-full flex flex-col gap-8 mt-0 pt-0 md:gap-6 ">
            ...
            <p className="mt-2 font-semibold text-[16px] md:text-[16px] lg:text-[16px] leading-[150%] tracking-normal text-black">
              Your brand deserves more than random posts and recycled trends. We
              start with strategy — mapping your audience, defining content
              pillars, and building weekly calendars that give your feed
              structure and purpose. Then we bring it to life with fast-paced
              creative sprints and posts designed to connect, not just fill
              space.{" "}
              <span className="font-bold">
                Every piece earns its place. Every post builds your brand.
              </span>
            </p>
          </article>
          ...
          <article className="w-full flex flex-col gap-8 md:gap-6">
            ...
            <p className="mt-2 font-semibold text-[16px] md:text-[16px] lg:text-[16px] leading-[150%] tracking-normal text-black">
              People connect with people and that’s why we tap into a global
              network of vetted creators to put real faces and real voices
              behind your brand. We handle the briefs, sourcing, and direction
              so you get a steady flow of native videos that feel at home on the
              platform, not like another ad.{" "}
              <span className="font-bold">
                Authentic content. Real reach. Built for the scroll.
              </span>
            </p>
          </article>
          ...
          <article className="w-full md:col-span-2 lg:col-span-1 flex justify-center lg:justify-start">
            <div className="w-full md:w-2/3 lg:w-auto flex flex-col gap-8 md:gap-6">
              ...
              <p className="mt-2 font-semibold text-[16px] md:text-[16px] lg:text-[16px] leading-[150%] tracking-normal text-black">
                From stunning pitch decks and polished documents to bold web
                graphics and social posts, we design content that makes your
                brand look as good as it sounds. And when stills aren’t enough,
                we bring it all to life with animation and video production that
                moves the story forward.{" "}
                <span className="font-bold">
                  Beautiful design. Seamless motion. Creative built to stand out
                  on every screen.
                </span>
              </p>
            </div>
      ...
      <div className="block md:hidden mt-[-1rem] px-[4vw]">
        ...
        <div className="space-y-20">
          ...
          >
            ...
            <p className="text-sm text-black/80 leading-relaxed">
              From stunning pitch decks and polished documents to bold web
              graphics and social posts, we design content that makes your brand
              look as good as it sounds. And when stills aren't enough, we bring
              it all to life with animation and video production that moves the
              story forward.{" "}
              <span className="font-bold">
                Beautiful design. Seamless motion. Creative built to stand out
                on every screen.
