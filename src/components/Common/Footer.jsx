      ...
      <div className="hidden md:block  mx-auto w-full max-w-[90vw] px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6 pt-6">
          ...
          <div className="flex flex-wrap items-center gap-6 text-base">
            <a href="/privacy-policy" className="hover:text-brand hover:text-base text-sm ease-in-out duration-200 cursor-pointer">Privacy Policy</a>
            ...
            <a href="/cookies" className="hover:text-brand hover:text-base text-sm ease-in-out duration-200 cursor-pointer">Cookies Settings</a>
          </div>
        </div>
      </div>
