...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen max-w-[95vw] mx-auto bg-white">
      ...
      <section className="contact pb-8 sm:pb-12 md:pb-12 lg:pb-16 px-0 mt-8 md:mt-0 sm:px-6 md:px-8 lg:px-16">
        <div className="max-w-full mx-auto">
          <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-0 lg:items-stretch">
            ...
            <div className="relative order-1 lg:order-2 h-64 sm:h-80 md:h-96 lg:h-[30rem]">
              <img
